        ...
        try {
            adView.apply {
                ...
                if (nativeAd.callToAction != null) {
                    if(!specialBigLayouts.contains(layoutId)){
//                    if (layoutId != R.layout.layout_ad_native_big_3) {
    ...
    companion object {
        ...
        var smallLayouts = listOf(
            R.layout.native_ad_small, R.layout.native_ad_small_2, R.layout.native_ad_small_3,
            R.layout.native_ad_small, R.layout.native_ad_small_2, R.layout.native_ad_small_3,
            R.layout.native_ad_small, R.layout.native_ad_small_2, R.layout.native_ad_small_3,
        )

        var specialBigLayouts = listOf(
            R.layout.layout_ad_native_big_3, R.layout.layout_ad_native_big_4
        )
    }
}
